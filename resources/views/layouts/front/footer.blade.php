<!--== Start Footer Area Wrapper ==-->
  <footer class="footer-area">
    <div class="footer-main">
                ...
                <div class="row row-cols-3 row-gutter-10">
                  <div class="col">
                    <div class="gallery-item">
                      <img src="{{ asset('front/img/photos/gallery1.jpg') }}" alt="Givest-HasTech">
                      <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                    </div>
                  </div>
                  <div class="col">
                    <div class="gallery-item">
                      <img src="{{ asset('front/img/photos/gallery2.jpg') }}" alt="Givest-HasTech">
                      <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                    </div>
                  </div>
                  <div class="col">
                    <div class="gallery-item">
                      <img src="{{ asset('front/img/photos/gallery3.jpg') }}" alt="Givest-HasTech">
                      <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                    </div>
                  </div>
                  <div class="col">
                    <div class="gallery-item">
                      <img src="{{ asset('front/img/photos/gallery4.jpg') }}" alt="Givest-HasTech">
                      <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                    </div>
                  </div>
                  <div class="col">
                    <div class="gallery-item">
                      <img src="{{ asset('front/img/photos/gallery5.jpg') }}" alt="Givest-HasTech">
                      <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                    </div>
                  </div>
                  <div class="col">
                    <div class="gallery-item">
                      <img src="{{ asset('front/img/photos/gallery6.jpg') }}" alt="Givest-HasTech">
                      <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                    </div>
                  </div>
                </div>
      ...
      <!--== Scroll Top Button ==-->
      <div class="scroll-to-top"><img src="{{ asset('front/img/icons/arrow-up-line.png') }}" alt="Icon-Image"></div>
    </div>
    ...
    <div class="shape-layer">
      <img src="{{ asset('front/img/shape/footer-line.png') }}" alt="Image-Givest">
    </div>
  </footer>
