        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form class="form-single-submit" action="{{ route('courses.update', $course->id) }}" method="post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <select name="tag_id" class="form-control form-control-sm @error('tag_id') is-invalid @enderror" id="tag_id" required>
                                    ...
                                    @foreach ($tags as $tag)
                                    <option value="{{ $tag->id }}"@if($tag->id == $course->tag_id){{ 'selected' }}@endif>{{ $tag->tag_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text"  maxlength="254" class="form-control form-control-sm @error('course_code') is-invalid @enderror" id="course_code" name="course_code" value="{{ $course->course_code }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text"  maxlength="254" class="form-control form-control-sm @error('course_name') is-invalid @enderror" id="course_name" name="course_name" value="{{ $course->course_name }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text"  maxlength="254" class="form-control form-control-sm @error('course_title') is-invalid @enderror" id="course_title" name="course_title" value="{{ $course->course_title }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <textarea class="form-control" rows="3" id="course_summary" name="course_summary" required>{{ $course->course_summary }}</textarea>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <textarea class="form-control" rows="7" id="course_description" name="course_description" required> {{ $course->course_description }}</textarea>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2 mb-3">
                                <input type="text"  maxlength="254" class="form-control form-control-sm @error('course_price') is-invalid @enderror" id="course_price" name="course_price" value="{{ $course->course_price }}" required>
                            ...
                            <div class="col-md-2 mb-3">
                                <select name="currency_id" class="form-control form-control-sm @error('currency_id') is-invalid @enderror" id="currency_id" required>
                                    ...
                                    <option value="{{ $currency->id }}"@if($currency->id == $course->currency_id){{ 'selected' }}@endif>{{ $currency->currency_symbol }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="file" name="course_image" id="course_image" onchange="loadPreview(this);" class="form-control form-control-sm @error('course_image') is-invalid @enderror" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <img id="preview_img" src="{{ asset('uploads/courses/'.$course->course_image) }}" class="" width="220" height="170">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">
                                <label for="course_shown">Featured Course <span class="text-danger"> *</span></label>
                            </div>
                            <div class="col-md-4 mb-3">
                                <select name="course_shown" class="form-control form-control-sm @error('course_shown') is-invalid @enderror" id="course_shown" required>
                                    ...
                                    <option value="1"@if($course->course_shown == 1){{ 'selected' }}@endif>Active</option>
                                    <option value="0"@if($course->course_shown == 0){{ 'selected' }}@endif>Disabled</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <select name="course_status" class="form-control form-control-sm @error('course_status') is-invalid @enderror" id="course_status" required>
                                    ...
                                    <option value="0"@if($course->course_status == 0){{ 'selected' }}@endif>Disabled</option>
